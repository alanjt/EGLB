...
Copy all files and directories from the either the pre war or the post war EGLB directory into this local scenery directory. You should now have a directories C:\Flightgear\MyScenery\EGLB and C:\Flightgear\MyScenery\X2WY.
